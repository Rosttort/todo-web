...
export function sign_in(login, password){
    ...
    const token_url = 'https://rosttort.pythonanywhere.com/api/token'
...
export function sign_up(login, password){
    ...
    const users_url = 'https://rosttort.pythonanywhere.com/api/users/'
    const authorization_token = '04eb8ca4afcewjd34e7cecbf6095dfbc39fdb54'
...
export function get_projects(user_token){
    const projects_url = 'https://rosttort.pythonanywhere.com/api/projects/'
    const header = {'Authorization': 'Token ' + user_token}
